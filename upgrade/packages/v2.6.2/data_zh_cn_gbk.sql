-- shop_cofig表中增加“用户留言是否审核”开关
INSERT INTO `ecs_shop_config` (`id` ,`parent_id` ,`code` ,`type` ,`store_range` ,`store_dir` ,`value` ,`sort_order`) VALUES (NULL , '2', 'message_check', 'select', '1,0', '', '1', '1');
...
-- 增加邮件服务器支持SSL开关
INSERT INTO `ecs_shop_config` (`id` ,`parent_id` ,`code` ,`type` ,`store_range` ,`store_dir` ,`value` ,`sort_order`) VALUES (NULL , '5', 'smtp_ssl', 'select', '0,1', '', '0', '1');
