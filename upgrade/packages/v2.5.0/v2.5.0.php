 ...
 * ---------------------------------------------
 * $Author: scottye $
 * $Date: 2007-11-09 16:50:55 +0800 (星期五, 09 十一月 2007) $
...
class up_v2_5_0
{
    ...
    function update_database_optionally()
    {
        ...
        $change_type = array(
            'zh_cn' => array('帐户冲值', '帐户提款', '购买商品', '订单退款', 'init' => '初始化'),
            'zh_tw' => array('帳戶沖值', '帳戶提款', '購買商品', '訂單退款', 'init' => '初始化'),
            'en_us' => array('saving', 'drawing', 'buying', 'refundment',  'init' => 'initialize')
        );
