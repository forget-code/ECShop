...
<tr>
  <td>
      <span id="install-btn"><input type="button" class="button" value="<?php echo $lang['prev_step'];?><?php echo $lang['readme_page'];?>"  onclick="location.href='index.php?step=readme'" />
