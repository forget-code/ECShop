(function () {
    ...
    function AppAuthenticationService($rootScope, $localStorage, $cookies) {
        ...
        try{
            ...
            $rootScope.siteName = $cookies.get('siteName');
        }
        catch(e){
        ...
        service.getSiteName = _getSiteName;
        service.setSiteName = _setSiteName;
        ...
        function _setSiteName(siteName) {
            ...
            try{
                ...
                exdate.setMinutes(exdate.getMinutes + EXPIRED_MINUTE);
                options.expires = exdate;
                $cookies.put('siteName',siteName,options);
            } catch (e){
