...
$_LANG['cfg_name']['shop_info'] = '商店基本資料';
...
$_LANG['cfg_name']['integral_name'] = '消費積點名稱';
$_LANG['cfg_name']['integral_scale'] = '積點換算比例';
$_LANG['cfg_name']['integral_percent'] = '積點付款比例';
$_LANG['cfg_name']['enable_order_check'] = '是否啟用新訂單提醒';
$_LANG['cfg_name']['default_storage'] = '預設庫存量';
...
$_LANG['cfg_name']['bought_goods'] = '同時購買推薦數量';
...
$_LANG['cfg_name']['order_ship_note'] = '設定訂單為「已發貨」時';
$_LANG['cfg_name']['order_unship_note'] = '設定訂單為「未發貨」時';
$_LANG['cfg_name']['when_dec_storage'] = '什麼時候減少庫存';
$_LANG['cfg_name']['send_ship_email'] = '發貨時';
$_LANG['cfg_name']['order_receive_note'] = '設定訂單為「收貨確認」時';
...
$_LANG['cfg_name']['close_comment'] = '關閉網站的原因';
...
$_LANG['cfg_name']['one_step_buy'] = '是否一頁購物';
...
$_LANG['cfg_name']['email_content']  = '您好！這是一封檢測郵件伺服器設定的測試郵件。收到此郵件，意味著您的郵件伺服器設定正確！您可以進行其它郵件發送的操作了！';
$_LANG['cfg_name']['sms'] = '手機簡訊設定';
$_LANG['cfg_name']['sms_shop_mobile'] = '商家的手機號碼';
$_LANG['cfg_name']['sms_order_placed'] = '客戶下訂單時是否發手機簡訊給商家';
$_LANG['cfg_name']['sms_order_payed'] = '客戶付款時是否發手機簡訊給商家';
$_LANG['cfg_name']['sms_order_shipped'] = '商家發貨時是否發手機簡訊給客戶';
...
$_LANG['cfg_name']['cron_method'] = '是否允許遠端呼叫工作排程';
...
$_LANG['cfg_name']['name_of_region_1'] = '第一層配送區域名稱';
$_LANG['cfg_name']['name_of_region_2'] = '第二層配送區域名稱';
$_LANG['cfg_name']['name_of_region_3'] = '第三層配送區域名稱';
$_LANG['cfg_name']['name_of_region_4'] = '第四層配送區域名稱';
...
$_LANG['cfg_desc']['rewrite'] = 'URL重寫是一種搜尋引擎最佳化技術，可以將動態的網址模擬成靜態的HTML檔案。這個功能需要Apache的支援。';
$_LANG['cfg_desc']['integral_name'] = '您可以將消費積點重新命名。例如：燒幣';
$_LANG['cfg_desc']['integral_scale'] = '每100積點可抵多少元現金';
$_LANG['cfg_desc']['integral_percent'] = '每100元商品裡最多有多少金額可以使用積點來兌換';
$_LANG['cfg_desc']['comments_number'] = '顯示在商品詳情頁的使用者評論數量。';
$_LANG['cfg_desc']['shop_title'] = '商店的標題將顯示在瀏覽器的標題欄';
$_LANG['cfg_desc']['smtp_host'] = '郵件伺服器主機地址。如果本機可以發送郵件則設定為localhost';
$_LANG['cfg_desc']['smtp_user'] = '發送郵件所需的認證帳號，如果沒有請留空';
$_LANG['cfg_desc']['bought_goods'] = '顯示多少個「購買此商品的人還買過哪些商品」';
$_LANG['cfg_desc']['currency_format'] = '顯示商品價格的格式，%s將被替換為相應的價格數字。';
$_LANG['cfg_desc']['image_height'] = '如果您的伺服器支援GD，在您上傳商品圖片的時候將自動將圖片縮小到指定的尺寸。';
...
$_LANG['cfg_desc']['stats_code'] = '您可以將其他網站統計公司所提供的程式碼插入到每一個頁面。';
$_LANG['cfg_desc']['cache_time'] = '前台頁面暫存檔的存活時間，以秒為單位。';
...
$_LANG['cfg_desc']['skype'] = '如果您有多個客服的Skype號碼，請在每個號碼之間使用半形逗號（,）分隔。提示：你需要在你的Skype隱私設定中啟用狀態顯示功能';
$_LANG['cfg_desc']['attr_related_number'] = '在商品詳情頁面顯示多少個屬性關聯的商品。';
$_LANG['cfg_desc']['user_notice'] = '該訊息將在使用者中心歡迎頁面顯示';
...
$_LANG['cfg_range']['cart_confirm'][1] = '顯示提示方塊,按下確定進入購物車';
$_LANG['cfg_range']['cart_confirm'][2] = '顯示提示方塊,按下取消進入購物車';
$_LANG['cfg_range']['cart_confirm'][3] = '不顯示提示方塊,直接進入購物車';
$_LANG['cfg_range']['cart_confirm'][4] = '不顯示提示方塊,不進行任何動作';
...
$_LANG['cfg_range']['enable_order_check']['0'] = '禁用';
$_LANG['cfg_range']['enable_order_check']['1'] = '啟用';
...
$_LANG['cfg_range']['timezone']['8'] = '(GMT +08:00) 北京、香港、新加坡、台北';
...
$_LANG['cfg_range']['upload_size_limit']['default'] = '伺服器預設值';
...
$_LANG['cfg_desc']['mail_service'] = '如果您採用伺服器內建的mail功能，那麼您不需要填寫下面的內容。';
$_LANG['cfg_range']['mail_service'][0] = '採用伺服器內建的mail功能';
...
$_LANG['mail_save_success'] = '儲存郵件設定成功。';
$_LANG['sendemail_success'] = '恭喜！測試郵件已成功發送到 ';
$_LANG['sendemail_false'] = '郵件發送失敗，請檢查您的郵件伺服器設定！';

$_LANG['js_languages']['smtp_host_empty']   = '您沒有填寫郵件伺服器位置!';
$_LANG['js_languages']['smtp_port_empty']   = '您沒有填寫伺服器連接埠!';
$_LANG['js_languages']['reply_email_empty'] = '您沒有填寫郵件回覆地址!';
$_LANG['js_languages']['test_email_empty']  = '您沒有填寫發送測試郵件的信箱!';
$_LANG['js_languages']['email_address_same']  = '郵件回覆地址與發送測試郵件的信箱不能相同!';

$_LANG['cfg_name']['wap']   = 'WAP設定';
$_LANG['cfg_name']['wap_config']    = '是否使用WAP功能(此功能只支援簡體中文且只在中國大陸區有效)';
$_LANG['cfg_range']['wap_config'][0] = '禁用';
$_LANG['cfg_range']['wap_config'][1] = '啟用';
$_LANG['cfg_name']['wap_logo']      = 'WAP LOGO上傳';
$_LANG['cfg_desc']['wap_logo']      = '為了更好地兼容各種手機類型，LOGO最好為png圖片';

$_LANG['cfg_range']['upload_size_limit']['0'] = '預設';
$_LANG['cfg_range']['upload_size_limit']['64'] = '64KB';
$_LANG['cfg_range']['upload_size_limit']['128'] = '128KB';
$_LANG['cfg_range']['upload_size_limit']['256'] = '256KB';
$_LANG['cfg_range']['upload_size_limit']['512'] = '512KB';
