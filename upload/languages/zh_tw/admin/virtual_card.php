...
$_LANG['user_guide'] = '使用說明：' .
        '<ol>' .
          ...
          '<li>加密串保存在文件 includes/lib_code.php 中，對應的常量是 AUTH_KEY</li>' .
          '<li>如果要更改加密串，首先要修改文件 lib_code.php，把 OLD_AUTH_KEY 設置為更改前使用的加密串，把 AUTH_KEY 修改為新加密串；然後在下面的文本框中輸入原加密串和新加密串，點\'確定\'按鈕後即可</li>' .
        '</ol>';
