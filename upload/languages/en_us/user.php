...
$_LANG['surplus_amount'] = 'Your saving amount is:';
...
$_LANG['current_surplus'] = 'Your current balance is:';
...
$_LANG['amount_gt_zero'] = 'Please input a number which is greater than zero at Amount';
$_LANG['select_payment_pls'] = 'Please choose payment';
...
$_LANG['please_select'] = 'Please_select...';
...
$_LANG['merge_order_notice'] = 'Combine orders refers to consolidating the orders in the same condition into a new order.';
$_LANG['order_exist'] = 'The order is nonexistent!';
$_LANG['order_is_group_buy'] = '[Associates]';
$_LANG['gb_deposit'] = '(Bail)';
$_LANG['notice_gb_order_amount'] = '(Remarks: If associates with insurance, the insurance and
corresponding pay need to be paid in first payment.)';
...
$_LANG['virtual_card_info'] = 'virtual_card_infomation';
...
$_LANG['profile_lnk'] = 'View my profile.';
$_LANG['login_failure'] = 'Sorry, there is no match for that userid and/or password';
...
$_LANG['your_level'] = 'Your level is %s ';
$_LANG['next_level'] = ',you need %s points to %s ';
...
/* The user_passport.dwt js language file*/
...
/* user_clips.dwt js language file */
...
$_LANG['register_affiliate'] = '推荐会员注册送积分';
