...
function get_promotion_info($goods_id = '')
{
    ...
    $favourable = array();
    $sql = 'SELECT act_id, act_name, start_time, end_time FROM ' . $GLOBALS['ecs']->table('favourable_activity') . " WHERE start_time <= '$gmtime' AND end_time >= '$gmtime'";
    if(!empty($goods_id))
    {
