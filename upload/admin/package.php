 ...
 * ============================================================================
 * $Author: zblikai $
 * $Id: package.php 15487 2008-12-22 09:32:06Z zblikai $
*/
...
if ($_REQUEST['act'] == 'add')
{
    ...
    $package     = array('package_price'=>'', 'start_time' => $start_time, 'end_time' => $end_time, 'option'=>'<option value="0">'.$_LANG['make_option'].'</option>');
...
elseif ($_REQUEST['act'] =='insert')
{
    ...
    $record = array('act_name'=>$_POST['package_name'], 'act_desc'=>$_POST['desc'],
                    'act_type'=>GAT_PACKAGE, 'goods_id'=>$_POST['goods_id'], 'goods_name'=>$_POST['goods_name'],
...
elseif ($_REQUEST['act'] == 'edit')
{
    ...
    $package['option']  = '<option value="'.$package['goods_id'].'">'.$package['goods_name'].'</option>';
...
elseif ($_REQUEST['act'] =='update')
{
    ...
    /* 更新数据 */
    $record = array('act_name' => $_POST['package_name'], 'goods_id' => $_POST['goods_id'], 'goods_name' =>$_POST['goods_name'],
...
function get_packagelist()
{
    ...
    if ($result === false)
    {
        ...
        /* 获活动数据 */
        $sql = "SELECT act_id, act_name AS package_name, goods_name, start_time, end_time, is_finished, ext_info ".
